...
class AirLeak:
    ...
    @staticmethod
    def eqn_4_10__hr(
        T: float, V: float, del_P: float, lb: float, leakage: float, t: float
    ):
    ...
    @staticmethod
    def eqn_4_10__t(
        T: float, V: float, del_P: float, hr: float, lb: float, leakage: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__T(
        V: float, del_P: float, hr: float, lb: float, leakage: float, t: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__del_P(
        T: float, V: float, hr: float, lb: float, leakage: float, t: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__lb(
        T: float, V: float, del_P: float, hr: float, leakage: float, t: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        pass  # double parens issue. see reverse polish

    @staticmethod
    def eqn_4_10__leakage(
        T: float, V: float, del_P: float, hr: float, lb: float, t: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__V(
        T: float, del_P: float, hr: float, lb: float, leakage: float, t: float
    ):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
