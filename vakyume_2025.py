...
class VacuumTheory:
    ...
    @staticmethod
    def eqn_1_11__q(M: float, P: float, T: float, W: float, min: float):
    ...
    @staticmethod
    def eqn_1_11__P(M: float, T: float, W: float, min: float, q: float):
        # [.pyeqn] q = W * (359 / M) * (760 / P) * (T / 492) * (1/60) ft^3/min
        result = []
        P = 6821*T*W/(738*M*q)
        result.append(P)
    ...
    @staticmethod
    def eqn_1_11__T(M: float, P: float, W: float, min: float, q: float):
        # [.pyeqn] q = W * (359 / M) * (760 / P) * (T / 492) * (1/60) ft^3/min
        result = []
        T = 738*M*P*q/(6821*W)
        result.append(T)
    ...
    @staticmethod
    def eqn_1_11__min(M: float, P: float, T: float, W: float, q: float):
        # [.pyeqn] q = W * (359 / M) * (760 / P) * (T / 492) * (1/60) ft^3/min
        pass # double parens issue. see reverse polish

    @staticmethod
    def eqn_1_11__W(M: float, P: float, T: float, min: float, q: float):
        # [.pyeqn] q = W * (359 / M) * (760 / P) * (T / 492) * (1/60) ft^3/min
        result = []
        W = 738*M*P*q/(6821*T)
        result.append(W)
    ...
    @staticmethod
    def eqn_1_11__M(P: float, T: float, W: float, min: float, q: float):
        # [.pyeqn] q = W * (359 / M) * (760 / P) * (T / 492) * (1/60) ft^3/min
        result = []
        M = 6821*T*W/(738*P*q)
        result.append(M)
...
class AirLeak:
    ...
    @staticmethod
    def eqn_4_10__hr(T: float, V: float, del_P: float, lb: float, leakage: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        pass # double parens issue. see reverse polish

    @staticmethod
    def eqn_4_10__t(T: float, V: float, del_P: float, hr: float, lb: float, leakage: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__T(V: float, del_P: float, hr: float, lb: float, leakage: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__del_P(T: float, V: float, hr: float, lb: float, leakage: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__lb(T: float, V: float, del_P: float, hr: float, leakage: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        pass # double parens issue. see reverse polish

    @staticmethod
    def eqn_4_10__leakage(T: float, V: float, del_P: float, hr: float, lb: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
    ...
    @staticmethod
    def eqn_4_10__V(T: float, del_P: float, hr: float, lb: float, leakage: float, t: float):
        # [.pyeqn] leakage = 0.0059 * V * del_P / t * 530 / T   lb/hr
        result = []
...
class SelectingPump:
    ...
    def eqn_8_1__SCON(NC: float, NS: float, installation_cost: float):
        # [.pyeqn] installation_cost = 16000 * (NS + 2 * NC) * (SCON / 1000) ** 0.35
        pass # will not solve float exponential
