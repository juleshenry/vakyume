...
class LiquidRing:
    ...
    def eqn_10_19__P(
        ...
        P = (p_s * (460 + T_i) - power_term * p_c * (460 + T_e)) / (
            (460 + T_i) - power_term * (460 + T_e)
        )
        return [P]
    ...
    def eqn_10_20__p_c(
        ...
        if denominator == 0:
            raise ValueError(
                "Division by zero error: (P - p_0) * (460 + T_i) equals zero"
            )
    ...
    def eqn_10_20__p_s(
        ...
        if denominator == 0:
            raise ValueError(
                "Division by zero error: expression_value * P * (460 + T_e) equals zero"
            )
...
class RotaryPistonVane:
    ...
    def eqn_11_02__Q_0(
        ...
        if exp_term == 1:
            raise ValueError(
                "Cannot solve for Q_0 when exp_term equals 1 (division by zero)"
            )

        Q_0 = (SP_1 - Q_external_gas_throughput - exp_term * SP_2 + exp_term * Q) / (
            exp_term - 1
        )
    ...
    def eqn_11_02__S_vol_pump_speed(
        ...
        if t == 0:
            raise ValueError(
                "Cannot solve for S_vol_pump_speed when t equals 0 (division by zero)"
            )
    ...
    def eqn_11_02__V(
        ...
        if log_term == 0:
            raise ValueError(
                "Cannot solve for V when ln(numerator/denominator) equals 0 (division by zero)"
            )
    ...
    def eqn_11_02__t(
        ...
        if S_vol_pump_speed == 0:
            raise ValueError(
                "Cannot solve for t when S_vol_pump_speed equals 0 (division by zero)"
            )
