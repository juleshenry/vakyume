...
class SelectingPump:
    ...
    def eqn_8_1__SCON(NC: float, NS: float, installation_cost: float):
        ...
        return [
            (
                (1000 / (((16000 * (NS + 2 * NC)) / installation_cost) ** (-1 / 0.35)))
                ** 4
            )
        ]
    ...
    def eqn_8_6__k(
        ...
        C = (
            numerator * ratio_of_pressures
        )  # This is a placeholder for an actual calculated value.
...
class RotaryPistonVane:
    ...
    def eqn_11_2__S_vol_pump_speed(
        ...
        ln_term = np.log(
            (SP_1 - (Q_external_gas_throughput + Q_0)) / (SP_2 - (Q + Q_0))
        )
