...
std::vector<double> Kinematics_eqn_1_2__a(double t, double v0, double x,
                                          double x0) {
  std::vector<double> result;
...
std::vector<double> Kinematics_eqn_1_2__t(double a, double v0, double x,
                                          double x0) {
  std::vector<double> result;
  double t =
      (((-v0) -
        std::sqrt(((((2.0 * a) * x) - ((2.0 * a) * x0)) + std::pow(v0, 2.0)))) /
       a);
  result.push_back(t);
  t = (((-v0) +
        std::sqrt(((((2.0 * a) * x) - ((2.0 * a) * x0)) + std::pow(v0, 2.0)))) /
...
std::vector<double> Kinematics_eqn_1_2__v0(double a, double t, double x,
                                           double x0) {
  std::vector<double> result;
...
std::vector<double> Kinematics_eqn_1_2__x(double a, double t, double v0,
                                          double x0) {
  std::vector<double> result;
...
std::vector<double> Kinematics_eqn_1_2__x0(double a, double t, double v0,
                                           double x) {
  std::vector<double> result;
