...
class FluidFlowVacuumLines:
    ...
    def eqn_2_11__D(
        self, L: float, f: float, g_c: float, h_r: float, v: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
        D = L * f * v**2 / (2 * g_c * h_r)
    ...
    def eqn_2_11__L(
        self, D: float, f: float, g_c: float, h_r: float, v: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
        L = 2 * D * g_c * h_r / (f * v**2)
    ...
    def eqn_2_11__f(
        self, D: float, L: float, g_c: float, h_r: float, v: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
        f = 2 * D * g_c * h_r / (L * v**2)
    ...
    def eqn_2_11__g_c(
        self, D: float, L: float, f: float, h_r: float, v: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
        g_c = L * f * v**2 / (2 * D * h_r)
    ...
    def eqn_2_11__h_r(
        self, D: float, L: float, f: float, g_c: float, v: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
        h_r = L * f * v**2 / (2 * D * g_c)
    ...
    def eqn_2_11__v(
        self, D: float, L: float, f: float, g_c: float, h_r: float, **kwargs
    ):
        # h_r = f * L * v ** 2 / (D * 2 * g_c)
        result = []
    ...
    def eqn_2_14__M(
        self, R: float, T: float, g_c: float, k: float, v_s: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
        M = R * T * g_c * k / v_s**2
    ...
    def eqn_2_14__R(
        self, M: float, T: float, g_c: float, k: float, v_s: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
        R = M * v_s**2 / (T * g_c * k)
    ...
    def eqn_2_14__T(
        self, M: float, R: float, g_c: float, k: float, v_s: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
        T = M * v_s**2 / (R * g_c * k)
    ...
    def eqn_2_14__g_c(
        self, M: float, R: float, T: float, k: float, v_s: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
        g_c = M * v_s**2 / (R * T * k)
    ...
    def eqn_2_14__k(
        self, M: float, R: float, T: float, g_c: float, v_s: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
        k = M * v_s**2 / (R * T * g_c)
    ...
    def eqn_2_14__v_s(
        self, M: float, R: float, T: float, g_c: float, k: float, **kwargs
    ):
        # v_s = (k * g_c * R / M * T) ** 0.5
        result = []
    ...
    def eqn_2_19b__Re(
        self, h: float, mu: float, rho: float, v: float, w: float, **kwargs
    ):
    ...
    def eqn_2_19b__h(
        self, Re: float, mu: float, rho: float, v: float, w: float, **kwargs
    ):
        # Re = (2 * w * h * rho * v) / ((w + h) * mu)
        result = []
    ...
    def eqn_2_19b__mu(
        self, Re: float, h: float, rho: float, v: float, w: float, **kwargs
    ):
        # Re = (2 * w * h * rho * v) / ((w + h) * mu)
        result = []
    ...
    def eqn_2_19b__rho(
        self, Re: float, h: float, mu: float, v: float, w: float, **kwargs
    ):
        # Re = (2 * w * h * rho * v) / ((w + h) * mu)
        result = []
    ...
    def eqn_2_19b__v(
        self, Re: float, h: float, mu: float, rho: float, w: float, **kwargs
    ):
        # Re = (2 * w * h * rho * v) / ((w + h) * mu)
        result = []
    ...
    def eqn_2_19b__w(
        self, Re: float, h: float, mu: float, rho: float, v: float, **kwargs
    ):
        # Re = (2 * w * h * rho * v) / ((w + h) * mu)
        result = []
...
class VacuumTheory:
    ...
    def eqn_1_10__P_2(
        self, P_1: float, T_1: float, T_2: float, V_1: float, V_2: float, **kwargs
    ):
        # P_1 * V_1 / T_1 = P_2 * V_2 / T_2
        result = []
    ...
    def eqn_1_10__T_1(
        self, P_1: float, P_2: float, T_2: float, V_1: float, V_2: float, **kwargs
    ):
        # P_1 * V_1 / T_1 = P_2 * V_2 / T_2
        result = []
    ...
    def eqn_1_10__T_2(
        self, P_1: float, P_2: float, T_1: float, V_1: float, V_2: float, **kwargs
    ):
        # P_1 * V_1 / T_1 = P_2 * V_2 / T_2
        result = []
    ...
    def eqn_1_10__V_1(
        self, P_1: float, P_2: float, T_1: float, T_2: float, V_2: float, **kwargs
    ):
        # P_1 * V_1 / T_1 = P_2 * V_2 / T_2
        result = []
    ...
    def eqn_1_10__V_2(
        self, P_1: float, P_2: float, T_1: float, T_2: float, V_1: float, **kwargs
    ):
        # P_1 * V_1 / T_1 = P_2 * V_2 / T_2
        result = []
