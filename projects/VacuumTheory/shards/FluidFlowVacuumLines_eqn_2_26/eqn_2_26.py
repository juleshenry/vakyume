...
class FluidFlowVacuumLines:
    eqn_2_26__D = staticmethod(eqn_2_26__D)
    eqn_2_26__L = staticmethod(eqn_2_26__L)
    eqn_2_26__P_downstream = staticmethod(eqn_2_26__P_downstream)
    eqn_2_26__P_p = staticmethod(eqn_2_26__P_p)
    eqn_2_26__P_upstream = staticmethod(eqn_2_26__P_upstream)
    eqn_2_26__mu = staticmethod(eqn_2_26__mu)
    eqn_2_26__q = staticmethod(eqn_2_26__q)
