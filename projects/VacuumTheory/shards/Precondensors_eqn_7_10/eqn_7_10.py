...
class Precondensors:
    eqn_7_10__L_c_P = staticmethod(eqn_7_10__L_c_P)
    eqn_7_10__Q_condensor_heat_duty = staticmethod(eqn_7_10__Q_condensor_heat_duty)
    eqn_7_10__del_T = staticmethod(eqn_7_10__del_T)
