...
class PressMgmt:
    eqn_3_13__H_1 = staticmethod(eqn_3_13__H_1)
    eqn_3_13__H_2 = staticmethod(eqn_3_13__H_2)
    eqn_3_13__KAPPA_2 = staticmethod(eqn_3_13__KAPPA_2)
    eqn_3_13__P = staticmethod(eqn_3_13__P)
