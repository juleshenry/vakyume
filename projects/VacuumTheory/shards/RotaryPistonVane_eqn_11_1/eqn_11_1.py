...
class RotaryPistonVane:
    eqn_11_1__PS = staticmethod(eqn_11_1__PS)
    eqn_11_1__Q_0 = staticmethod(eqn_11_1__Q_0)
    eqn_11_1__Q_external_gas_throughput = staticmethod(eqn_11_1__Q_external_gas_throughput)
    eqn_11_1__V = staticmethod(eqn_11_1__V)
    eqn_11_1__dP = staticmethod(eqn_11_1__dP)
    eqn_11_1__dT = staticmethod(eqn_11_1__dT)
