...
class Precondensors:
    eqn_7_16__D_0 = staticmethod(eqn_7_16__D_0)
    eqn_7_16__D_LM = staticmethod(eqn_7_16__D_LM)
    eqn_7_16__D_i = staticmethod(eqn_7_16__D_i)
    eqn_7_16__R_f_0 = staticmethod(eqn_7_16__R_f_0)
    eqn_7_16__R_fi = staticmethod(eqn_7_16__R_fi)
    eqn_7_16__U_0 = staticmethod(eqn_7_16__U_0)
    eqn_7_16__h_0 = staticmethod(eqn_7_16__h_0)
    eqn_7_16__h_i = staticmethod(eqn_7_16__h_i)
    eqn_7_16__k_w = staticmethod(eqn_7_16__k_w)
    eqn_7_16__x_w = staticmethod(eqn_7_16__x_w)
