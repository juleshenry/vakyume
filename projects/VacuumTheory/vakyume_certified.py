...
class FluidFlowVacuumLines:
    ...
    @staticmethod
    def eqn_2_12__L(d: float, delta_P: float, f: float, g: float, rho: float, v: float, **kwargs):
    ...
    @staticmethod
    def eqn_2_12__d(L: float, delta_P: float, f: float, g: float, rho: float, v: float, **kwargs):
        # [.pyeqn] delta_P = 4.31 * rho * f * L * v ** 2 / (2 * d * g)
        result = []
    ...
    @staticmethod
    def eqn_2_12__delta_P(L: float, d: float, f: float, g: float, rho: float, v: float, **kwargs):
        # [.pyeqn] delta_P = 4.31 * rho * f * L * v ** 2 / (2 * d * g)
        result = []
    ...
    @staticmethod
    def eqn_2_12__f(L: float, d: float, delta_P: float, g: float, rho: float, v: float, **kwargs):
        # [.pyeqn] delta_P = 4.31 * rho * f * L * v ** 2 / (2 * d * g)
        result = []
    ...
    @staticmethod
    def eqn_2_12__rho(L: float, d: float, delta_P: float, f: float, g: float, v: float, **kwargs):
        # [.pyeqn] delta_P = 4.31 * rho * f * L * v ** 2 / (2 * d * g)
        result = []
    ...
    @staticmethod
    def eqn_2_12__v(L: float, d: float, delta_P: float, f: float, g: float, rho: float, **kwargs):
        # [.pyeqn] delta_P = 4.31 * rho * f * L * v ** 2 / (2 * d * g)
        result = []
    ...
    @staticmethod
    def eqn_2_28__C(D: float, L: float, P_p: float, mu: float, **kwargs):
    ...
    @staticmethod
    def eqn_2_28__D(C: float, L: float, P_p: float, mu: float, **kwargs):
        # [.pyeqn] C = 3.141592653589793 * D ** 4 / (128 * mu * L) * P_p
        result = []
    ...
    @staticmethod
    def eqn_2_28__L(C: float, D: float, P_p: float, mu: float, **kwargs):
        # [.pyeqn] C = 3.141592653589793 * D ** 4 / (128 * mu * L) * P_p
        result = []
    ...
    @staticmethod
    def eqn_2_28__mu(C: float, D: float, L: float, P_p: float, **kwargs):
        # [.pyeqn] C = 3.141592653589793 * D ** 4 / (128 * mu * L) * P_p
        result = []
    ...
    @staticmethod
    def eqn_2_5__L(D: float, delta_P: float, mu: float, q: float, **kwargs):
        # [.pyeqn] q = 3.141592653589793 * (D ** 4) * delta_P / (128 * L * mu)
        result = []
    ...
    @staticmethod
    def eqn_2_5__mu(D: float, L: float, delta_P: float, q: float, **kwargs):
        # [.pyeqn] q = 3.141592653589793 * (D ** 4) * delta_P / (128 * L * mu)
        result = []
    ...
    @staticmethod
    def eqn_2_8__M(P_c: float, T_c: float, mu_c: float, **kwargs):
    ...
    @staticmethod
    def eqn_2_8__P_c(M: float, T_c: float, mu_c: float, **kwargs):
        # [.pyeqn] mu_c = (7.7 * (M ** 0.5) * P_c ** (2 / 3)) / T_c ** (1 / 6)
        result = []
    ...
    @staticmethod
    def eqn_2_8__T_c(M: float, P_c: float, mu_c: float, **kwargs):
        # [.pyeqn] mu_c = (7.7 * (M ** 0.5) * P_c ** (2 / 3)) / T_c ** (1 / 6)
        result = []
    ...
    @staticmethod
    def eqn_2_8__mu_c(M: float, P_c: float, T_c: float, **kwargs):
        # [.pyeqn] mu_c = (7.7 * (M ** 0.5) * P_c ** (2 / 3)) / T_c ** (1 / 6)
        result = []
...
class LiquidRing:
    ...
    @staticmethod
    def eqn_10_16__P(S_0: float, S_Th: float, p_0: float, **kwargs):
    ...
    @staticmethod
    def eqn_10_16__S_0(P: float, S_Th: float, p_0: float, **kwargs):
        # [.pyeqn] S_Th = S_0 * (P / (P - p_0)) ** 0.6
        result = []
    ...
    @staticmethod
    def eqn_10_16__p_0(P: float, S_0: float, S_Th: float, **kwargs):
        # [.pyeqn] S_Th = S_0 * (P / (P - p_0)) ** 0.6
        result = []
...
class PressMgmt:
    ...
    @staticmethod
    def eqn_3_9__H_1(A_C: float, H_2: float, P: float, V: float, **kwargs):
        # [.pyeqn] P = A_C * H_2 * (H_2 - H_1) / (V - A_C * H_2)
        result = []
    ...
    @staticmethod
    def eqn_3_9__P(A_C: float, H_1: float, H_2: float, V: float, **kwargs):
        # [.pyeqn] P = A_C * H_2 * (H_2 - H_1) / (V - A_C * H_2)
        result = []
...
class ProcessApp1:
    ...
    @kwasak_static
    def eqn_5_9(D=None, L_0=None, V_1=None, **kwargs):
        return
...
class SelectingPump:
    ...
    @staticmethod
    def eqn_8_4__hp(installed_costs: float, **kwargs):
