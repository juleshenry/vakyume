...
class VacuumTheory:
    ...
    @kwasak_static
    def eqn_1_03(v: float = None, m: float = None, T: float = None, k: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_07(V: float = None, T: float = None, n: float = None, R: float = None, p: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_08(m: float = None, V: float = None, T: float = None, M: float = None, P: float = None, R: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_09(T: float = None, M: float = None, P: float = None, rho: float = None, R: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_10(T_2: float = None, T_1: float = None, P_1: float = None, V_2: float = None, V_1: float = None, P_2: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_11(q: float = None, T: float = None, M: float = None, P: float = None, W: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_1_13b(P: float = None, y_a: float = None, p_a: float = None,**kwargs):
        return
...
class FluidFlowVacuumLines:
    ...
    @kwasak_static
    def eqn_2_01(D: float = None, mu: float = None, Re: float = None, rho: float = None, v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_02(psi: float = None, delta: float = None, lambd: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_03(lambd: float = None, kn: float = None, D: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_04(mu: float = None, vel_grad: float = None, _beta: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_05(q: float = None, D: float = None, mu: float = None, L: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_08(mu_c: float = None, T_c: float = None, P_c: float = None, M: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_10(Suc_Pres: float = None, oper_press: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_11(D: float = None, f: float = None, L: float = None, v: float = None, h_r: float = None, g_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_12(g: float = None, f: float = None, d: float = None, L: float = None, rho: float = None, v: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_13(q: float = None, f: float = None, d: float = None, L: float = None, rho: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_14(k: float = None, T: float = None, M: float = None, R: float = None, v_s: float = None, g_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_17(mu: float = None, d: float = None, L: float = None, v: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_2_17(q: float = None, mu: float = None, d: float = None, L: float = None, delta_P: float = None,**kwargs):
        return
...
class PressMgmt:
    ...
    @kwasak_static
    def eqn_3_01(BarometricPressure: float = None, Vacuum: float = None, Abs_Pressure: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_3_02(H: float = None, G_C: float = None, P: float = None, rho: float = None, G: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_3_03(P: float = None, P_P: float = None, H_1: float = None, H_2: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_3_05(P: float = None, V_P: float = None, P_P: float = None, V: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_3_06(H_1: float = None, V_P: float = None, V: float = None, P: float = None, H_2: float = None,**kwargs):
        return
...
class AirLeak:
    ...
    @kwasak_static
    def eqn_4_07(sum_individual_leak_rates: float = None, W_T: float = None, W: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_4_10(del_P: float = None, V: float = None, T: float = None, t: float = None, leakage: float = None,**kwargs):
        return
...
class ProcessAppI:
    ...
    @kwasak_static
    def eqn_5_01(x_i: float = None, K_i: float = None, y_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_02a(K_2: float = None, alpha_1_2: float = None, K_1: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_02b(x_2: float = None, x_1: float = None, y_2: float = None, K_2: float = None, K_1: float = None, y_1: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_03(p_i: float = None, x_i: float = None, P_0_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_04(P: float = None, x_i: float = None, y_i: float = None, P_0_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_05(P_0_2: float = None, alpha_12: float = None, P_0_1: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_06(p_i: float = None, x_i: float = None, gamma_i: float = None, P_0_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_07(x_i: float = None, gamma_i: float = None, P: float = None, y_i: float = None, P_0_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_08(gamma_2: float = None, P_0_2: float = None, alpha_12: float = None, gamma_1: float = None, P_0_1: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_09(L_0: float = None, V_1: float = None, D: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_10a(L_0: float = None, V_1: float = None, D: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_10c(L_0: float = None, R: float = None, D: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_11(B: float = None, V_0: float = None, L_N: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_12(N_t: float = None, Eff: float = None, T: float = None, N_ES: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_14(P_0: float = None, T: float = None, M: float = None, W_E: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_15(M_2: float = None, P_0_2: float = None, P_0_1: float = None, a_M_12: float = None, M_1: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_16(p_i: float = None, x_i: float = None, H_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_5_17(x_3: float = None, H_2_3: float = None, x_1: float = None, H_2_1: float = None, H_2_mi: float = None,**kwargs):
        return
...
class ProcessAppIi:
    ...
    @kwasak_static
    def eqn_6_01(T_2: float = None, T_1: float = None, del_h_v: float = None, c_p: float = None, T_R: float = None, w_1: float = None, w_v: float = None, w_2: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_02(Q_v: float = None, T_2: float = None, T_1: float = None, c_p: float = None, T_R: float = None, w_1: float = None, w_2: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_04(Q_v: float = None, w_v: float = None, delta_h_v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_07(T_2: float = None, T_1: float = None, delta_h_c: float = None, m_b: float = None, c_p: float = None, C_1: float = None, C_2: float = None, m_v: float = None, delta_h_v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_08(T_2: float = None, delta_t: float = None, T_1: float = None, delta_h_c: float = None, m_b: float = None, c_p: float = None, C_1: float = None, C_2: float = None, delta_h_v: float = None, w_v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_09(m: float = None, dV_dt: float = None, A: float = None, r_M: float = None, mu: float = None, r: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_10(dV_dt: float = None, A: float = None, mu: float = None, tau: float = None, s: float = None, r_c: float = None, delta_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_6_11a(delta_h_i: float = None, delta_m: float = None, m_b: float = None, A_d: float = None, delta_T: float = None, h_d: float = None, t_R: float = None,**kwargs):
        return
...
class Precondensors:
    ...
    @kwasak_static
    def eqn_7_02(P_i_0: float = None, x_i: float = None, p_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_03(P_i_0: float = None, epsilon_i: float = None, x_i: float = None, p_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_04a(P: float = None, p_nc: float = None, p_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_04aa(p_nc: float = None, n_nc: float = None, n_i: float = None, p_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_04ab(p_nc: float = None, p: float = None, P_c: float = None, p_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_04ac(p_i: float = None, p: float = None, P_c: float = None, n_nc: float = None, n_i: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_05(N_i: float = None, p_i: float = None, N_nc: float = None, P: float = None, P_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_06(W_air: float = None, x_i: float = None, W_i: float = None, M: float = None, P: float = None, P_i_0: float = None, p_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_07(W_air: float = None, W_i: float = None, x_i: float = None, epsilon_i: float = None, M: float = None, P: float = None, P_i_0: float = None, p_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_08(Q_condensor_heat_duty: float = None, del_T: float = None, L_c: float = None, c_p: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_09(L_c: float = None, c_p: float = None, rho: float = None, Q_condensor_heat_duty: float = None, del_T: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_10(Q_condensor_heat_duty: float = None, del_T: float = None, L_c_P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_11(del_T_LM: float = None, Q_condensor_heat_duty: float = None, V_c: float = None, U_v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_12(Q_condensor_heat_duty: float = None, del_T: float = None, A: float = None, U: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_14a(del_T_LM: float = None, A: float = None, U: float = None, Q_condensor_heat_duty: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_14b(del_T_2: float = None, A: float = None, del_T_1: float = None, U: float = None, Q_condensor_heat_duty: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_16(k_w: float = None, x_w: float = None, h_i: float = None, R_f_0: float = None, D_i: float = None, U_0: float = None, R_fi: float = None, h_0: float = None, D_LM: float = None, D_0: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_7_18(k_w: float = None, x_w: float = None, h_i: float = None, h_c: float = None, R_nc: float = None, D_i: float = None, U_0: float = None, R_fi: float = None, R_fo: float = None, D_LM: float = None, D_0: float = None,**kwargs):
        return
...
class SelectingPump:
    ...
    def eqn_8_01__SCON(NC: float, NS: float, installation_cost: float):
        ...
        # [Sympy Failover]
        """
        Solves the equation `0 = 16000 * (NS + 2 * NC) * (SCON / 1000)**0.35 - installation_cost` for SCON, given values of NS, NC and installation_cost.
        
        :param NC: Number of cells in the system (float).
        :param NS: Nameplate capacity of the solar array (float).
        :param installation_cost: Cost of installing a kWh unit (float).
        :return: Solar collector cost per kWp (float).
        """
        
        # Step 1: Add installation_cost to both sides of the equation
        right_side = installation_cost + 16000 * (NS + 2 * NC) * (SCON / 1000) ** 0.35
        
        # Step 2: Isolate (SCON / 1000) on one side
        SCON_over_1000 = right_side / (16000 * (NS + 2 * NC))
        
        # Step 3: Multiply both sides by 1000 to solve for SCON
        SCON = SCON_over_1000 ** (1/0.35) * 1000
    ...
    def eqn_8_03__hp(installed_costs: float):
        ...
        # [Sympy Failover]
        """
        Solves the equation for hp given installed_costs using logarithmic transformation to remove the exponent.
        
        :param installed_costs: The total cost of installation as a floating-point number.
        :return: The calculated horsepower (hp) as a floating-point number.
        """
        # Apply the reciprocal power to both sides, with an exponent of 1/0.45
        adjusted_installed_costs = installed_costs ** (1 / 0.45)
        
        # Multiply by 10 and then take the reciprocal to isolate hp
        horsepower = 10 * (adjusted_installed_costs ** (1 / 0.45)) / 10
    ...
    @kwasak_static
    def eqn_8_06(k: float = None, w: float = None, T: float = None, M: float = None, R: float = None, P_1: float = None, P_2: float = None, adiabatic_hp: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_8_07(P_2: float = None, P_1: float = None, adiabatic_hp: float = None, w: float = None,**kwargs):
        return
    ...
    def eqn_8_07__P_2(P_1: float, adiabatic_hp: float, w: float):
        ...
        # [Sympy Failover]
        """
        Solve the given equation for P_2 in terms of P_1, adiabatic_hp and w.
        
        Parameters:
        P_1 (float): The initial pressure.
        adiabatic_hp (float): The adiabatic heat power.
        w (float): The work done per unit mass flow rate.
        
        Returns:
        float: Calculated value of P_2.
        """
        reciprocal_power = 1 / 0.286
        term = adiabatic_hp / (w / 20)
        
        # Solving for P_2 in terms of P_1, and the other variables
        P_2 = P_1 * pow(term, reciprocal_power)
    ...
    def eqn_8_07__P_1(P_2: float, adiabatic_hp: float, w: float):
        ...
        # [Sympy Failover]
        """
        Solves for P_1 using the given equation with respect to P_2.
        
        Parameters:
            P_2 (float): The pressure value used in the equation.
            adiabatic_hp (float): The adiabatic heat power.
            w (float): The weight parameter.
            
        Returns:
            float: Calculated value of P_1.
        """
        # First, calculate the term inside the parentheses
        denominator = adiabatic_hp / (w / 20)
        
        # Take the reciprocal and raise it to the power -1/0.286 to isolate P_1/P_2
        p_ratio = denominator ** (-1 / 0.286)
        
        # Multiply both sides by P_2 to solve for P_1
        P_1 = P_2 * p_ratio
    ...
    @kwasak_static
    def eqn_8_08(adiabatic_power_watts: float = None, P_2: float = None, P_1: float = None, f: float = None,**kwargs):
        return
    ...
    def eqn_8_08__P_2(P_1: float, adiabatic_power_watts: float, f: float):
        # [.pyeqn] adiabatic_power_watts = f / 12 * ((P_2 / P_1) ** 0.286 - 1)
        # [Sympy Failover]
        P_2 = P_1 * (1 ** (1 / 0.286)) + adiabatic_power_watts
        return [ P_2 ]
    ...
    def eqn_8_08__P_1(P_2: float, adiabatic_power_watts: float, f: float):
        # [.pyeqn] adiabatic_power_watts = f / 12 * ((P_2 / P_1) ** 0.286 - 1)
        # [Sympy Failover]
        numerator = -((f/12) - adiabatic_power_watts)
        reciprocal_exponent = 1 / 0.286
        right_side = (P_2 / numerator) ** reciprocal_exponent
        P_1 = 1 / right_side
        return [ P_1 ]
    ...
    @kwasak_static
    def eqn_8_09(E_j: float = None, E_m: float = None, r: float = None, s: float = None, e: float = None,**kwargs):
        return
...
class SteamJetInjectors:
    ...
    @kwasak_static
    def eqn_9_01(w_s: float = None, rho_s: float = None, A: float = None, v: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_9_02(P_m: float = None, w_s: float = None, rho_s: float = None, d_n: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_9_04(w_s: float = None, SC: float = None, AEL: float = None, r: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_9_05(t_h: float = None, r_h: float = None, w_h: float = None, V: float = None,**kwargs):
        return
...
class LiquidRing:
    ...
    @kwasak_static
    def eqn_10_01(sig_R: float = None, D_r: float = None, w: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_02(V: float = None, PS: float = None, dt: float = None, dP: float = None, Q_gas: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_03(N_mfw: float = None, T: float = None, Q_gas: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_04(SP_1: float = None, V: float = None, S_p: float = None, Q_gas: float = None, SP_2: float = None, t: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_05(V: float = None, S_p: float = None, P_1: float = None, P_2: float = None, t: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_06(V: float = None, P_1: float = None, P_2: float = None, t: float = None, S_a: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_08(f_a: float = None, delta_h_i: float = None, w_i: float = None, c_p: float = None, rho: float = None, bhp: float = None, delta_T: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_09(T_s: float = None, T_c: float = None, delta_T: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_10(rho: float = None, bhp: float = None, bhp_0: float = None, mu: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_16(P: float = None, S_Th: float = None, S_0: float = None, p_0: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_17(p_s: float = None, S_0: float = None, p_0: float = None, S_Th: float = None, P: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_18(T_i: float = None, p_s: float = None, S_p: float = None, T_e: float = None, S_Th: float = None, P: float = None, p_c: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_10_19(T_i: float = None, p_s: float = None, S_p: float = None, T_e: float = None, S_Th: float = None, P: float = None, p_c: float = None,**kwargs):
        return
    ...
    def eqn_10_19__P(S_Th: float, S_p: float, T_e: float, T_i: float, p_c: float, p_s: float):
        ...
        left_side = P * ((P - p_c) * (460 + T_e)) ** 0.6
        
        right_side = S_p / S_Th * ((P - p_s) * (460 + T_i)) / (P - p_c) ** 0.6
        
        return left_side - right_side
        initial_guess = [20]  # An arbitrary starting point for the solution.
        P_solution = fsolve(eqn_10_19__P, initial_guess, args=(S_Th, S_p, T_e, T_i, p_c, p_s))
    ...
    @kwasak_static
    def eqn_10_20(T_i: float = None, p_s: float = None, S_0: float = None, p_0: float = None, S_p: float = None, T_e: float = None, P: float = None, p_c: float = None,**kwargs):
        return
    ...
    def eqn_10_20__T_i(P: float, S_0: float, S_p: float, T_e: float, p_0: float, p_c: float, p_s: float):
        ...
        # [Sympy Failover]
        left_side = ((S_0/S_p)**(1/0.6) * (P * (P - p_s)*(460 + T_e)) / ((P - p_0)*(P - p_c))) / P
        T_i = 1/(460*P) * left_side
        return [ T_i ]
    ...
    def eqn_10_20__p_c(P: float, S_0: float, S_p: float, T_e: float, T_i: float, p_0: float, p_s: float):
        ...
        # [Sympy Failover]
        """
        Calculate the value of p_c using given parameters.
        
        Parameters:
            P (float): The variable for which we want to find p_c.
            S_0 (float): Initial entropy value.
            S_p (float): Process entropy value.
            T_e (float): Final temperature.
            T_i (float): Initial temperature.
            p_0 (float): Reference pressure at initial temperature.
            p_s (float): Critical pressure.
            
        Returns:
            float: The calculated value of p_c in terms of P, S_0, S_p, T_e, T_i, p_0, and p_s.
        """
        
        numerator = S_p * ((P - p_0) * (460 + T_i)) / (P * (P - p_s) * (460 + T_e))
        denominator = 1/0.6
        p_c = P - (numerator ** denominator) - S_0
...
class RotaryPistonVane:
    ...
    @kwasak_static
    def eqn_11_01(V: float = None, PS: float = None, dT: float = None, dP: float = None, Q_0: float = None, Q_external_gas_throughput: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_11_02(SP_1: float = None, V: float = None, S_vol_pump_speed: float = None, Q: float = None, SP_2: float = None, Q_0: float = None, t: float = None, Q_external_gas_throughput: float = None,**kwargs):
        return
    ...
    def eqn_11_02__SP_1(Q: float, Q_0: float, Q_external_gas_throughput: float, SP_2: float, S_vol_pump_speed: float, V: float, t: float):
        ...
        # [Sympy Failover]
        SP_1 = exp(t * (V / S_vol_pump_speed)) * (SP_2 - (Q + Q_0)) + (Q_external_gas_throughput + Q_0)
        return [ SP_1 ]
    ...
    def eqn_11_02__S_vol_pump_speed(Q: float, Q_0: float, Q_external_gas_throughput: float, SP_1: float, SP_2: float, V: float, t: float):
        # [.pyeqn] t = V / S_vol_pump_speed * ln( (SP_1 - (Q_external_gas_throughput + Q_0))/ (SP_2 - (Q + Q_0)))
        # [Sympy Failover]
        ln_ratio = log(SP_1 / SP_2)
        return [ (t * ln_ratio) / (V / ln_ratio) * ((SP_2 - Q - Q_0) / (SP_1 - (Q_external_gas_throughput + Q_0))) ]
    ...
    def eqn_11_02__Q(Q_0: float, Q_external_gas_throughput: float, SP_1: float, SP_2: float, S_vol_pump_speed: float, V: float, t: float):
        ...
        denominator = exp(t * S_vol_pump_speed / V)
        SP_2_minus_Q = SP_2 - Q
        
        temp = numerator / denominator
        
        result = (-temp + SP_2 - Q_0)
    ...
    def eqn_11_02__SP_2(Q: float, Q_0: float, Q_external_gas_throughput: float, SP_1: float, S_vol_pump_speed: float, V: float, t: float):
        ...
        SP_2 = (SP_1 - Q_0 - (Q + Q_external_gas_throughput)*exp_ratio) / (-exp_ratio)
    ...
    def eqn_11_02__Q_0(Q: float, Q_external_gas_throughput: float, SP_1: float, SP_2: float, S_vol_pump_speed: float, V: float, t: float):
        # [.pyeqn] t = V / S_vol_pump_speed * ln( (SP_1 - (Q_external_gas_throughput + Q_0))/ (SP_2 - (Q + Q_0)))
        # [Sympy Failover]
        e_t = exp(t)  # Calculate e**t
        
        numerator = SP_1 - Q_external_gas_throughput - e_t * Q
        denominator = e_t + 1
    ...
    def eqn_11_02__t(Q: float, Q_0: float, Q_external_gas_throughput: float, SP_1: float, SP_2: float, S_vol_pump_speed: float, V: float):
        ...
        # [Sympy Failover]
        """
        Calculate the time (t) using a given equation.
        
        Parameters:
        Q (float): The gas throughput in quantity.
        Q_0 (float): Initial external gas throughput.
        Q_external_gas_throughput (float): External gas throughput.
        SP_1 (float): Set Point 1 pressure.
        SP_2 (float): Set Point 2 pressure.
        S_vol_pump_speed (float): Volume pump speed in units per time.
        V (float): Total volume of the system.
        
        Returns:
        float: Calculated time 't' based on given parameters and equation.
        """
        numerator = SP_1 - (Q + Q_0)
        denominator = SP_2 - (Q + Q_external_gas_throughput + Q_0)
        
        if denominator == 0:
            raise ValueError("Denominator cannot be zero, as it leads to a division by zero error.")
            
        time = V / S_vol_pump_speed * log(numerator / denominator)
        return [ time ]
    ...
    def eqn_11_02__Q_external_gas_throughput(Q: float, Q_0: float, SP_1: float, SP_2: float, S_vol_pump_speed: float, V: float, t: float):
        ...
        # [Sympy Failover]
        numerator = SP_2 - SP_1
        denominator = (1 / exp(t * S_vol_pump_speed / V)) - 1
        Q_external_gas_throughput = numerator / denominator + Q_0
        return [ Q_external_gas_throughput ]


    @kwasak_static
    def eqn_11_03(t_c: float = None, F_s: float = None, t: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_11_05(P_0_v: float = None, p_g: float = None, p_v_max: float = None, P_D: float = None,**kwargs):
        return
    ...
    @kwasak_static
    def eqn_11_06(p_b: float = None, p_g: float = None, p_v_max: float = None, S_D: float = None, S_B: float = None, P_0_V: float = None, P_D: float = None, P_v_0: float = None,**kwargs):
        return
