...
solvers with an LLM, and assembling certified solvers into a single library.
"""
...
# ---------------------------------------------------------------------------
#  Pipeline context (directory layout for a single project)
# ---------------------------------------------------------------------------
...
def analyze_results(ctx: PipelineContext, all_results):
    """Categorize verification results into solved / inconsistent / failed."""
